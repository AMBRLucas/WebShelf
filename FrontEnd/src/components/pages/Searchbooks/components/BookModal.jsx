...
function BookModal({ bookId, setBook }) {
    ...
    useEffect(() => {
        ...
        fetchData();
    }, [bookId, updateModal, loanModal, returnModal]);
            ...
            {!isLoading &&
                <div className="book-modal">
                    <div className="back-button" onClick={() => setBook(null)}>
                        <UilArrowLeft className="back-arrow"/>
                    </div>
                    <div className="book-infos">
                        ...
                        <div className="buttons">
                            ...
                            <button disabled={!bookData.loaned} onClick={() => setReturnModal(true)}>Return book</button>
                        </div>
                    </div>
                    ...
                    {returnModal && <ReturnModal bookId={bookData.id} setReturnModal={setReturnModal} />}
                </div>
            }
        </div>
    );
