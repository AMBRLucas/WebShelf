...
public class LoanController {
    ...
    public ResponseEntity<Void> returnBookById(@PathVariable String id){
        this.loanService.ReturnBookByBookId(id);
    ...
    @GetMapping("/monthly")
    @ResponseBody
    public List<Map<String, Object>> getLoansByMonth (@RequestParam int month, @RequestParam int year, @RequestParam String libraryId){
        return loanService.getLoanByDay(month, year, libraryId);
    }
}
